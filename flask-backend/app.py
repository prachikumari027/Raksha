...
# Symptom and disease dictionaries (as in original)
symptoms_dict = {
    "itching": 0,
    "skin_rash": 1,
...
# we are using this so that nan value should be converted to null for passing in json
...
def get_disease_details(disease):
    ...
    pre_row = precautions[precautions["Disease"] == disease][
        ["Precaution_1", "Precaution_2", "Precaution_3", "Precaution_4"]
    ]
    pre_list = pre_row.values[0].tolist() if len(pre_row) else []
